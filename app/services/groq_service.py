...
"""
    ...
    async def agent(
        ...
        agent_prompt = f"""You are in Agent mode. Read the user's request and respond with: 1) A short goal statement summarizing what you will accomplish; 2) A prioritized, numbered list of actions you will take or recommend (with expected outcomes); 3) If necessary, ask any clarifying questions. User request:
